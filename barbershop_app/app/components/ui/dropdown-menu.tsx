/**
 * @file barbershop_app/app/components/ui/dropdown-menu.tsx
 * @description This file exports a set of accessible dropdown menu components built on top of Radix UI's DropdownMenu primitive.
 * It provides a complete dropdown solution including root, trigger, content, items, and various specialized item types (checkbox, radio).
 */
...
// The button that triggers the dropdown menu to open or close.
...
// A group for radio button items, where only one can be selected.
...
// A single radio button item within a radio group.
...
// A component to display a keyboard shortcut next to a menu item.
...
// The root component for a nested sub-menu.
...
// The trigger for a nested sub-menu.
